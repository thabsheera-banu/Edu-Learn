...
function CourceDetail() {
  ...
  const handleCloseModal = () => {
   ...
   const handlePayment = () => {
    ...
    axios.post(BaseUrl + 'course/razorpay/pay/', requestData)
      .then((res) => {
        setPaymentData(res.data);
        // Redirect to the payment gateway
        // Replace the following line with your actual payment gateway redirection logic
        window.location.href = res.data.payment.razorpay_url;
      })
      .catch((error) => {
        console.log(error);
      });
          ...
          <div className="card-body">
            <div className="row">
              ...
              <div className="col-md-8">
                ...
                <p className="card-text fw-bold mt-1">Duration: <a href="#">3 hours 30 minutes</a></p>
                <p className="card-text fw-bold mt-1">Total Enrolled: <a href="#">40</a></p>
